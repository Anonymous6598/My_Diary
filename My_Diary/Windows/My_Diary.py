import customtkinter, tkinter, tkinter.filedialog, tkinter.messagebox, pickle, os, sys, docx, typing, My_Diary_interface, My_Diary_window, CTkMenuBar, locale, My_Diary_converterer, My_Diary_PDF_viewer, speech_recognition, My_Diary_AI_window, g4f, CTkToolTip, tkinterdnd2, My_Diary_bash_terminal, warnings
...
class Program(My_Diary_window.My_Diary_window, My_Diary_interface.My_Diary_interface):
    ...
    def __init__(self: typing.Self, *args, **kwargs) -> None:
        ...
        if locale.getdefaultlocale()[0] == f"sr_RS":
            ...
            self.main_screen_menu_terminal_button: customtkinter.CTkButton = self.main_screen_title_menu_submenu.add_option(option=f"terminal", command=lambda: My_Diary_bash_terminal.My_Diary_bash_terminal())	
